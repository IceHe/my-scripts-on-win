...
/*
 * Copy the template of .php file to current directory.
 */
echo "\n";
...
$src_fname = "TPL.php";
$src_fp = WP(TPLS) . $src_fname;	// WP() just for window cmd

$des_fname = ("" == $file_name ? "UNTITLED" : $file_name) . ".php";
$des_path = "./";
$des_fp = WP($des_path) . $des_fname;	// WP() just for window cmd

echo "PHP src_fp = [{$src_fp}]\n";
echo "PHP des_fp = [{$des_fp}]\n";

/* copy TPL.php file to cur dir */
...
if(0 != exec_and_log($command, "PHP new .php file [{$des_fp}]",
